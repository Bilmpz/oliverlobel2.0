...
export default function Contact() {
  ...
  const validate = () => {
    const e = {}
    if (!form.navn.trim())   e.navn   = 'Navn er påkrævet'
    if (!form.email.trim())  e.email  = 'E-mail er påkrævet'
    else if (!/\S+@\S+\.\S+/.test(form.email)) e.email = 'Ugyldig e-mail'
    if (!form.emne)          e.emne   = 'Vælg et emne'
    if (!form.besked.trim()) e.besked = 'Besked er påkrævet'
    return e
  }
  ...
  const errStyle = { fontSize: 12, color: 'var(--accent)', marginTop: 4, display: 'block' }
  const inputErr = { borderColor: 'var(--accent)' }
    ...
    <main>
      <header className="ph">
        <div className="ph-in">
          ...
          <p className="ph-s">Har du et projekt eller et spørgsmål? Kontakt mig nedenfor.</p>
        </div>
      </header>
        ...
        <div className="w">
          <div className="cg">
            ...
            <Reveal>
              {success ? (
                <div className="f-ok">
                  ✓ &nbsp;Tak for din besked! Jeg vender tilbage inden for 1-2 hverdage.
                </div>
              ) : (
                <form onSubmit={handleSubmit}>
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }}>
                    <div className="ff">
                      ...
                      <input
                        ...
                        autoComplete="name"
                        style={errors.navn ? inputErr : {}}
                      />
                      {errors.navn && <span style={errStyle}>{errors.navn}</span>}
                    </div>
                    <div className="ff">
                  ...
                  <div className="ff">
                    ...
                    {errors.emne && <span style={errStyle}>{errors.emne}</span>}
                  </div>
                  ...
                  <div className="ff">
                    ...
                    <textarea
                      id="besked"
                      name="besked"
                      placeholder="Fortæl mig lidt om dit projekt…"
                      value={form.besked}
                      onChange={handleChange}
                      style={errors.besked ? inputErr : {}}
                    />
                    {errors.besked && <span style={errStyle}>{errors.besked}</span>}
                  </div>
            ...
            <Reveal delay={100}>
              <div className="ic-stack">
                <div className="ic">
                  ...
                  <h4>E-mail</h4>
                  <a href="mailto:oliver.lobel@yahoo.dk">oliver.lobel@yahoo.dk</a>
                </div>
                <div className="ic">
                  <div className="ic-ico"></div>
                  <h4>LinkedIn</h4>
                  <a href="https://www.linkedin.com/in/oliver-l%C3%B8bel-6a7435369/" target="_blank" rel="noopener noreferrer">linkedin.com/in/oliver-løbel</a>
                </div>
                <div className="ic">
                  <div className="ic-ico"></div>
                  <h4>GitHub</h4>
                  <a href="https://github.com/Bilmpz" target="_blank" rel="noopener noreferrer">github.com/Bilmpz</a>
                </div>
                <div className="ic" style={{ background: 'var(--bg)' }}>
                  <div className="ic-ico"></div>
                  <h4>Svartid</h4>
                  <p style={{ fontSize: 14, color: 'var(--ink-mid)', marginTop: 4 }}>
                    Typisk 1-2 hverdage.<br />Altid åben for et nyt projekt.
                  </p>
                </div>
              </div>
            </Reveal>
      ...
      <section className="surface-bg">
        <div className="w">
          ...
          <Reveal delay={50}>
            <h2 className="sh" style={{ marginBottom: 40 }}>
              Ofte stillede spørgsmål<span className="ac">?</span>
            </h2>
          </Reveal>
          <div className="tcg">
            {FAQ.map((f, i) => (
              <Reveal key={f.q} delay={i * 60}>
                <div className="tc" style={{ padding: 24 }}>
                  <h4 style={{ fontFamily: 'var(--fh)', fontSize: 16, fontWeight: 700, color: 'var(--ink)', marginBottom: 8 }}>
                    {f.q}
                  </h4>
                  <p style={{ fontSize: 14, fontWeight: 300, color: 'var(--ink-mid)', lineHeight: 1.7 }}>
                    {f.a}
                  </p>
                </div>
              </Reveal>
